const api_url: string = "https://127.0.0.1:8080";

async function send_api_request({endpoint, data, method} : {endpoint: string, data?: object, method?: "POST" | "GET" | "DELETE" | "PUT"}): Promise<Response> {
